...
export interface IPersonalTaskAPI {
     ...
     */
    getList(): Promise<IPersonalTaskListModel>;
     ...
     */
    getSubtaskList(id: number): Promise<Array<IPersonalTaskModel>>;
     ...
     */
    create(data: IPersonalTaskModel, is_subtask: boolean, parent_id: number): Promise<boolean | Array<string> >;
    
    /**
     * * DELETE Запрос
     * 
     * Удаляет персональную задачу/подзадачу.
     * 
     * Доступно только при авторизации.
     * 
     * Возможный Response:
