...
from api.v1.views.space_task import (SpaceTaskSet, SpaceSubTaskView,
                                     ...
                                     SpaceTaskMeView, )
from api.v1.views.personal_task import PersonalTaskSet, PersonalSubTaskView
...
router.register(r"space/(?P<org_id>\d+)/task",
...
urlpatterns = [
    ...
    path("space/<int:org_id>/task/<int:task_id>/subtasks/",
          SpaceSubTaskView.as_view(), name="sub_person_task"),
    path("space/<int:org_id>/task/history/",
         HistoryView.as_view(), name="history"),
    path("space/<int:org_id>/task/<int:task_id>/history/",
