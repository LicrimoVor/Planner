...
from api.v1.views.personal_task import PersonalTaskSet, OrganizationTaskMeSet, PersonalSubTaskView
...
#     path("organization/(?P<org_id>\d+)/task/(?P<task_id>\d+)/subtasks",
